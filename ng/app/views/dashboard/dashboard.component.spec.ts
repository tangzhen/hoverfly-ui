...
describe("Component: Dashboard", () => {
  ...
  const configureTestModule = function () {
    return TestBed.configureTestingModule({
      imports: [DashboardModule, NgReduxTestingModule],
      providers: [
  ...
  it("should show hoverfly configuration", () => {
    ...
    const destination = fixture.debugElement.query(
      By.css("#hoverfly-info-dest code")
    );
  ...
  it("should show middleware details if middleware is set", async(() => {
    ...
    configureTestModule().then(() => {
      const hoverflyStub = MockNgRedux.getSelectorStub([
        "hoverfly",
        "hoverfly",
      ]);
      ...
      const binaryField = fixture.debugElement.query(
        By.css("#hoverfly-middleware-details-binary code")
      );
      const remoteField = fixture.debugElement.query(
        By.css("#hoverfly-middleware-details-remote code")
      );
      const scriptBlock = fixture.debugElement.query(
        By.css("#hoverfly-middleware-details-script code")
      );
      const defaultBody = fixture.debugElement.query(
        By.css("#hoverfly-middleware-default-body")
      );
      ...
      expect(scriptBlock.nativeElement.textContent).toBe(
  ...
  it("should hide middleware details if middleware is not set", () => {
    const middlewareTable = fixture.debugElement.query(
      By.css("#hoverfly-middleware-details")
    );
    const defaultBody = fixture.debugElement.query(
      By.css("#hoverfly-middleware-default-body")
    );
  ...
  it("should initialize usage counters to zeros", () => {
    ...
    counters.children.forEach((c) =>
      expect(c.nativeElement.textContent).toBe("0")
    );
  });
  ...
  it("should set mode when click on mode selector", () => {
    const captureLink = fixture.debugElement.query(
      By.css("#hoverfly-mode-selector:first-child a")
    ).nativeElement;
    click(captureLink);
  ...
  it("should highlight current mode selector button", () => {
    ...
    const simulateLink = fixture.debugElement.query(
      By.css("#hoverfly-mode-selector [name=simulate]")
    );
